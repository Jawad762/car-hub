  ...
  return (
    <main className='flex flex-row w-full justify-between mt-16 pb-16 max-md:flex-col max-md:pb-0 max-md:gap-8 max-sm:gap-2'>
        <div className='flex flex-col items-left w-1/2 relative left-16 gap-6 max-md:w-full max-lg:w-1/2 max-lg:left-4 max-lg:left-4'>
            <h1 className='font-bold text-6xl w-1/2 leading-relaxed max-sm:w-2/3 max-md:w-full max-lg:text-4xl max-lg:w-full'>Find, book, rent a car—quick and super easy!</h1>
        ...
        <div className='max-lg:relative max-md:h-[50vh] max-lg:w-full overflow-x-hidden'>
          <Image height={1000} width={1000} className='absolute -top-24 -right-1/2 bg-hero-bg -z-10 w-full h-screen overflow-hidden max-md:top-0 max-md:-right-52 max-md:rotate-12 max-md:overflow-hidden max-md:h-full max-lg:h-5/6 max-lg:-right-32' src='https://raw.githubusercontent.com/adrianhajdin/project_next13_car_showcase/main/public/hero-bg.png'/>
