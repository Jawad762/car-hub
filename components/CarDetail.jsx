...
const CarDetail = () => {
  ...
  return (
    <>
        <main className={`fixed inset-0 flex border justify-center items-center transition-all duration-400 ${showModal ? 'opacity-100 scale-100 w-screen' : 'opacity-0 scale-0 w-0'} max-sm:overflow-hidden`}>
            <section className='h-full w-full bg-slate-50 flex flex-row justify-between items-center z-50 px-6 py-6 relative max-md:flex-col max-md:justify-start max-md:px-2 max-md:pt-8 max-sm:pt-10 max-sm:py-0 max-sm:overflow-hidden'>
                    ...
                    <div className='w-1/3 h-full flex flex-col items-left justify-center gap-6 max-md:w-full max-sm:gap-6 max-md:gap-2'>
