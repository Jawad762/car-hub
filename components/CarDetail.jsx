...
const CarDetail = () => {
  ...
  return (
    <>
        <main className={`h-screen fixed transition-all duration-400 top-0 right-0 ${showModal ? 'w-screen' : 'w-0'} max-sm:overflow-hidden`}>
            <section className='h-full w-full bg-slate-50 flex flex-row justify-between items-center z-50 px-6 py-6 relative max-md:flex-col max-md:justify-start max-md:px-2 max-md:pt-8 max-sm:pb-0 max-sm:overflow-hidden'>
                    ...
                    <div className='w-1/3 h-full flex flex-col items-left justify-center gap-6 max-md:w-full max-sm:gap-4 max-md:gap-2'>
